...
| Phase 03 | Dataset protocol and leakage audit | Not completed | Dataset artifacts exist under `data/` and `results/` | Household-level split/leakage audit, ethics/data availability, and reporting checklist are not completed. |
