...
Under the leakage-controlled Phase 04 protocol, the full PyTorch GraphSAGE model achieves test AUC \(0.5842 \pm 0.0487\) and test average precision \(0.7809 \pm 0.0295\) over 15 household-grouped runs. This is reported alongside stronger baselines rather than as a standalone model claim. The model output is retained only as one ranking signal, not as evidence of a deployable diagnostic classifier.
...
\midrule
Full PyTorch GraphSAGE & \(0.5842 \pm 0.0487\) & \(0.7809 \pm 0.0295\) \\
